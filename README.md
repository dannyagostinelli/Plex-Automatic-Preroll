...
## Installation
Nothing! well obviously python and maybe the plex api if you don't already have it but the script should prompt you to install the api if it is missing.

## Settings
The config.ini file is created through the script for ease of use. If you need to update it than you can edit the config.ini file I might add in # Plex-Monthly-Preroll
Automated script to change out plex preroll every month
...
## Installation
Nothing! well obviously python and maybe the plex api if you don't already have it but the script should prompt you for that.
